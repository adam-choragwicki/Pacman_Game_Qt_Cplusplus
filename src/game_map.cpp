...
GameMap::GameMap() : PATH_POINTS(generatePathPoints()), POWERBALL_POSITIONS(generatePowerballPositions()), FOODBALL_POSITIONS(generateFoodballPositions())
{

}

bool GameMap::isPathPointValid(const Coordinates& coordinates) const
{
    /*Check if given point is accessible for movable characters*/
    return PATH_POINTS.contains(coordinates);
}

std::set<Coordinates> GameMap::generatePathPoints()
{
...
std::set<Coordinates> GameMap::generatePathPointsBetweenPoints(int startX, int startY, int endX, int endY)
{
    std::set<Coordinates> pathPoints;
...
std::set<Coordinates> GameMap::generateFoodballPositions()
{
...
std::set<Coordinates> GameMap::generatePowerballPositions()
{
